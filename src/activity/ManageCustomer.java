...
public class ManageCustomer extends JFrame implements ActionListener {
	...
	private ViewCustomerActivity prev;
	...
	public ManageCustomer(String username, ViewCustomerActivity prev) {
		...
		userIdLabel = new JLabel("Customer name: "+customer.getUserName());
		...
		phoneNumberTF = new JTextField(customer.getPhoneNumber());
