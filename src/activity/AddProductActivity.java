...
public class AddProductActivity extends JFrame implements ActionListener {
	...
	private JLabel title, header, productNameLabel, productQtLabel, productPriceLabel,productPriceAfterLabel;
	private JTextField productNameTF, productQtTF, productPriceTF,productPriceAfterTF;
	public AddProductActivity(ViewProductActivity prev, Admin admin) {
		super("Add Product");
		...
		productPriceAfterLabel = new JLabel("Price sell: ");
		productPriceAfterLabel.setBounds(60, 340, 140, 30);
		productPriceAfterLabel.setFont(Theme.FONT_REGULAR);
		panel.add(productPriceAfterLabel);
		...
		productPriceAfterTF = new JTextField();
		productPriceAfterTF.setBounds(180, 340, 220, 30);
		productPriceAfterTF.setFont(Theme.FONT_INPUT);
		panel.add(productPriceAfterTF);
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonLogout)) {
			...
			this.setVisible(false);
			new ViewProductActivity(new AdminActivity(admin.getUserName()), admin).setVisible(true);
		}
			...
			try {
				...
				p.setSellingprice(Double.parseDouble(productPriceAfterTF.getText()));
				p.createProduct();
				productNameTF.setText("");
				productPriceTF.setText("");
				productQtTF.setText("");
				productPriceAfterTF.setText("");
