...
public class ManageProduct extends JFrame implements ActionListener {
	...
	private JButton buttonBack, buttonEdit, buttonDelete, buttonSubmit;
	private JLabel title, header, productIdLabel, productNameLabel, productQtLabel, productPriceLabel,productPriceAfterLabel;
	private JTextField productIdTF, productNameTF, productQtTF, productPriceTF, productPriceAfterTF;
	...
	public ManageProduct(String pid, ViewProductActivity prev) {
		...
		productPriceTF = new JTextField(product.getSellingprice()+"");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonEdit)) {
			...
			productPriceTF.setEnabled(true);
			productQtTF.setEnabled(true);
