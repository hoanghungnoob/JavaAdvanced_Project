...
public class ViewCustomerActivity extends JFrame implements ActionListener {
	...
	public ViewCustomerActivity(JFrame prev, Admin admin) {
		super("View Customer");
		...
		byWhatCB = new JComboBox(new Object[]{"By username", "By Name"});
	...
	private void jTable_ClickMouseClicked(MouseEvent evt) {                                          
       ...
       // value1 này sẽ trả về username trong Jtable
       String value1 = model.getValueAt(index, 0).toString();
       System.out.println("data xuất ra xem thử : "+value1);
